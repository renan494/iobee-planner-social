...
const mdComponents = {
  table: ({ children, ...props }: any) => {
    thColorIdx = 0;
    return (
      <div className="my-6 overflow-hidden rounded-2xl border-2 border-[#e8e4dd]">
  ...
  li: ({ children, ...props }: any) => (
    <li className="flex items-start gap-3 text-[17px] text-[#555] leading-[1.6]" {...props}>
      <span className="shrink-0 mt-2.5 h-2 w-2 rounded-full bg-[#FDB600]" />
  ...
  blockquote: ({ children, ...props }: any) => (
    <blockquote className="my-6 border-l-4 border-[#FDB600] bg-[#FDB600]/5 px-6 py-4 rounded-r-xl" {...props}>
